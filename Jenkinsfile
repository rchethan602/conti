pipeline {
    ...
    parameters {
        ...
        choice(name: 'NAMESPACE', choices: ['yosemite','sequoia','whiskeytown','demo','honda-sandbox','preprod','sandbox','demo','ioptesting','nissan-sandbox','preprod','rosie','santa-monica'], description: 'Target namespace in US', visible: {param.REGION == 'us-east-1'})
	choice(name: 'NAMESPACE', choices: ['preprod','wutai','qiyun','preprod','putuo'], description: 'Target namespace in CN', visible: {param.REGION == 'cn-north-1'} )
